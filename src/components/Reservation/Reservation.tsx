...
const Reservation = () => {
  return (
    <div className="flex justify-end items-center relative overflow-hidden h-screen">
      <img
        src={background}
        className="absolute w-full top-0 h-full object-cover"
      />
      <form className="flex flex-col items-center justify-center z-10 bg-white rounded-md p-10 gap-5 mr-20">
